    ...
    const Signup = ({ onLogin }) => {
      ...
      const handleSubmit = async (e) => {
        ...
        if (email === 'test@example.com') {
          ...
          alert('Signup successful! Use test@example.com and password to login.');
          navigate('/login');
        }
      };
          ...
          <div className="w-full max-w-md">
            ...
            <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-700 shadow-md rounded px-8 pt-6 pb-8 mb-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Link className="inline-block align-baseline font-bold text-sm text-primary dark:text-secondary hover:text-blue-800 dark:hover:text-yellow-200" to="/login">
